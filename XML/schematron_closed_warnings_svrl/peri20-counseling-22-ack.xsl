...
<!--SCHEMA SETUP-->
   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title=" Schematron file for MCCI_IN000002 - Acknowledgement Counseling bericht " schemaVersion="">
         <axsl:comment>
