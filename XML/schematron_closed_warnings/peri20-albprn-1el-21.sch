...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Obstetrisch aanleverbericht PRN 1e lijn (2.16.840.1.113883.2.4.3.11.60.90.77.4.1801 2012-08-06T00:00:00)</title>
   ...
   <!-- albprn-1el-20 -->
   <pattern>
      <title>albprn-1el-20</title>
      <rule context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:id[not(@nullFlavor)] | descendant-or-self::hl7:code[(@code = '900000' and @codeSystem = '2.16.840.1.113883.2.4.15.4')] | descendant-or-self::hl7:statusCode[@code = 'active'] | descendant-or-self::hl7:effectiveTime[not(@nullFlavor)] | descendant-or-self::hl7:subject2[hl7:CareProvisionEvent[hl7:templateId[@root = '2.16.840.1.113883.2.4.6.10.90.70']]]"
                 see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.2.4.6.10.90.70-2012-05-31T000000.html">(albprn-1el-20): In de instance werd tenminste één van de volgende elementen verwacht: descendant-or-self::hl7:id[not(@nullFlavor)] | descendant-or-self::hl7:code[(@code = '900000' and @codeSystem = '2.16.840.1.113883.2.4.15.4')] | descendant-or-self::hl7:statusCode[@code = 'active'] | descendant-or-self::hl7:effectiveTime[not(@nullFlavor)] | descendant-or-self::hl7:subject2[hl7:CareProvisionEvent[hl7:templateId[@root = '2.16.840.1.113883.2.4.6.10.90.70']]]</assert>
      </rule>
   </pattern>
