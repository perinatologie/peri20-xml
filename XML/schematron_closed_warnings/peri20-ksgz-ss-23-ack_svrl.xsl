...
<!--SCHEMA SETUP-->
   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="Schematron file for transaction Acknowledgement 2.3 (2.16.840.1.113883.2.4.3.11.60.90.77.4.2435 2016-10-11T11:20:51)" schemaVersion="">
         <axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron file for transaction Acknowledgement 2.3 (2.16.840.1.113883.2.4.3.11.60.90.77.4.2435 2016-10-11T11:20:51)</svrl:text>
