...
<!--SCHEMA SETUP-->
   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="Schematron file for transaction Acknowledgement Administratief geboortebericht (2.16.840.1.113883.2.4.3.11.60.90.77.4.2002 2012-09-21T00:00:00)" schemaVersion="">
         <axsl:comment>
...
<!--SCHEMATRON PATTERNS-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schematron file for transaction Acknowledgement Administratief geboortebericht (2.16.840.1.113883.2.4.3.11.60.90.77.4.2002 2012-09-21T00:00:00)</svrl:text>
