...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Kernset geboortezorg, subset screening 2.3 (2.16.840.1.113883.2.4.3.11.60.90.77.4.2434 2016-10-11T11:20:51)</title>
   ...
   <!-- Include the project schematrons related to scenario ksgz-ss-23 -->

   <!-- gzks-ss-23 -->
   <pattern>
      <title>gzks-ss-23</title>
      <rule context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:REPC_IN004014NL[hl7:interactionId[@root = '2.16.840.1.113883.1.6']]"
                 see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.2.4.6.10.90.75-2017-09-28T153922.html">(gzks-ss-23): In de instance werd het volgende element verwacht: descendant-or-self::hl7:REPC_IN004014NL[hl7:interactionId[@root = '2.16.840.1.113883.1.6']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.2.4.6.10.90.75-2017-09-28T153922.sch"/>
   <include href="include/2.16.840.1.113883.2.4.6.10.90.75-2017-09-28T153922-closed.sch"/>
