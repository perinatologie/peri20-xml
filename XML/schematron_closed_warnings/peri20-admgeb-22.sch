...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Administratief geboortebericht (2.16.840.1.113883.2.4.3.11.60.90.77.4.2001 2012-09-21T00:00:00)</title>
   ...
   <!-- Include the project schematrons related to scenario admgeb-22 -->

   <!-- admgeboorte-22 -->
   <pattern>
      <title>admgeboorte-22</title>
      <rule context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:PRPA_IN101301NL[hl7:interactionId[@root = '2.16.840.1.113883.1.6']]"
                 see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.2.4.6.10.90.901025-2015-01-22T000000.html">(admgeboorte-22): In de instance werd het volgende element verwacht: descendant-or-self::hl7:PRPA_IN101301NL[hl7:interactionId[@root = '2.16.840.1.113883.1.6']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.2.4.6.10.90.901025-2015-01-22T000000.sch"/>
   <include href="include/2.16.840.1.113883.2.4.6.10.90.901025-2015-01-22T000000-closed.sch"/>
