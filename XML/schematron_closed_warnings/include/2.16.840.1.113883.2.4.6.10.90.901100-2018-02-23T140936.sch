...
-->
   <rule context="*[hl7:organizer[@classCode='CONTAINER'][@moodCode='EVN'][hl7:templateId[@root='2.16.840.1.113883.2.4.6.10.90.901100']]]/hl7:organizer[@classCode='CONTAINER'][@moodCode='EVN'][hl7:templateId[@root='2.16.840.1.113883.2.4.6.10.90.901100']]/hl7:component[@typeCode='COMP'][hl7:observation[hl7:templateId[@root='2.16.840.1.113883.2.4.6.10.90.900976']]]">
      <extends rule="d14e50578-false-d401366e0"/>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20180320T180627/tmp-2.16.840.1.113883.2.4.6.10.90.901100-2018-02-23T140936.html"
              test="string(@typeCode)=('COMP')">(RedenVerwZw233): de waarde van @typeCode MOET 'COMP' zijn.</assert>
      <assert role="error"
...
-->
   <rule id="d14e50578-false-d401366e0" abstract="true">
      <assert role="error"
