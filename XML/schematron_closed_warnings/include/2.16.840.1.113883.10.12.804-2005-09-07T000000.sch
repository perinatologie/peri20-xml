...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron"
         id="template-2.16.840.1.113883.10.12.804-2005-09-07T000000">
...
-->
   ...
   <rule context="*[hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]]/hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]"
         id="d15e1029-false-d31861e0">
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="string(@classCode) = ('OBS')">(CDAObservationMediaSDTC): de waarde van classCode MOET 'OBS' zijn. Gevonden: "<value-of select="@classCode"/>"</assert>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="string(@moodCode) = ('EVN') or not(@moodCode)">(CDAObservationMediaSDTC): de waarde van moodCode MOET 'EVN' zijn. Gevonden: "<value-of select="@moodCode"/>"</assert>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="count(hl7:templateId[@root = '2.16.840.1.113883.10.12.804']) &gt;= 1">(CDAObservationMediaSDTC): element hl7:templateId[@root = '2.16.840.1.113883.10.12.804'] is required [min 1x].</assert>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="count(hl7:templateId[@root = '2.16.840.1.113883.10.12.804']) &lt;= 1">(CDAObservationMediaSDTC): element hl7:templateId[@root = '2.16.840.1.113883.10.12.804'] komt te vaak voor [max 1x].</assert>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="count(hl7:languageCode) &lt;= 1">(CDAObservationMediaSDTC): element hl7:languageCode komt te vaak voor [max 1x].</assert>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="count(hl7:value) &gt;= 1">(CDAObservationMediaSDTC): element hl7:value is required [min 1x].</assert>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="count(hl7:value) &lt;= 1">(CDAObservationMediaSDTC): element hl7:value komt te vaak voor [max 1x].</assert>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="count(hl7:subject[hl7:relatedSubject[@classCode]]) &lt;= 1">(CDAObservationMediaSDTC): element hl7:subject[hl7:relatedSubject[@classCode]] komt te vaak voor [max 1x].</assert>
   </rule>
   <!--
Template derived rules for ID: 2.16.840.1.113883.10.12.804
...
-->
   ...
   <rule context="*[hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]]/hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]/hl7:templateId[@root = '2.16.840.1.113883.10.12.804']"
         id="d15e1035-false-d32129e0">
      <extends rule="II"/>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
      ...
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="string(@root) = ('2.16.840.1.113883.10.12.804')">(CDAObservationMediaSDTC): de waarde van root MOET '2.16.840.1.113883.10.12.804' zijn. Gevonden: "<value-of select="@root"/>"</assert>
   </rule>
   <!--
Template derived rules for ID: 2.16.840.1.113883.10.12.804
...
-->
   ...
   <rule context="*[hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]]/hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]/hl7:id"
         id="d15e1040-false-d32148e0">
      <extends rule="II"/>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="(local-name-from-QName(resolve-QName(@xsi:type,.))='II' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(CDAObservationMediaSDTC): indien er een @xsi:type instructie aanwezig is MOET deze de waarde "{urn:hl7-org:v3}:II" bevatten. Gevonden "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
...
-->
   ...
   <rule context="*[hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]]/hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]/hl7:languageCode"
         id="d15e1042-false-d32163e0">
      <extends rule="CS"/>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
...
-->
   ...
   <rule context="*[hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]]/hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]/hl7:value"
         id="d15e1050-false-d32180e0">
      <extends rule="ED"/>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
...
-->
   <rule context="*[hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]]/hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]/hl7:entryRelationship[@typeCode]">
      <extends rule="d36093e0-false-d36099e0"/>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="@typeCode">(CDAObservationMediaSDTC): attribute @typeCode MOET aanwezig zijn.</assert>
      <let name="theAttValue"
           value="distinct-values(tokenize(normalize-space(@typeCode),'\s'))"/>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="not(@typeCode) or empty($theAttValue[not(. = (doc('include/voc-2.16.840.1.113883.1.11.19447-DYNAMIC.xml')/*/valueSet/conceptList/concept/@code))])">(CDAObservationMediaSDTC): de waarde van typeCode MOET worden gekozen uit waardelijst '2.16.840.1.113883.1.11.19447' x_ActRelationshipEntryRelationship (DYNAMISCH).</assert>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="not(@contextConductionInd) or string(@contextConductionInd)=('true','false')">(CDAObservationMediaSDTC): attribuut @contextConductionInd MOET datatype 'bl' hebben  - '<value-of select="@contextConductionInd"/>'</assert>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="not(@inversionInd) or string(@inversionInd)=('true','false')">(CDAObservationMediaSDTC): attribuut @inversionInd MOET datatype 'bl' hebben  - '<value-of select="@inversionInd"/>'</assert>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="not(@negationInd) or string(@negationInd)=('true','false')">(CDAObservationMediaSDTC): attribuut @negationInd MOET datatype 'bl' hebben  - '<value-of select="@negationInd"/>'</assert>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="count(hl7:sequenceNumber) &lt;= 1">(CDAObservationMediaSDTC): element hl7:sequenceNumber komt te vaak voor [max 1x].</assert>
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="count(hl7:seperatableInd) &lt;= 1">(CDAObservationMediaSDTC): element hl7:seperatableInd komt te vaak voor [max 1x].</assert>
   </rule>
...
-->
   <rule context="*[hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]]/hl7:observationMedia[hl7:templateId[@root = '2.16.840.1.113883.10.12.804']]/hl7:entryRelationship[@typeCode]/hl7:sequenceNumber">
      ...
      <assert role="error"
              see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.10.12.804-2005-09-07T000000.html"
              test="not(@value) or matches(@value, '^-?[1-9]\d*$|^+?\d*$')">(CDAObservationMediaSDTC): @value is geen geldig INT getal <value-of select="@value"/>
      </assert>
   </rule>
...
-->
   <rule id="d36093e0-false-d36099e0" abstract="true">
      <let name="elmcount"
