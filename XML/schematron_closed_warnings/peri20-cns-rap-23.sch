...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Counseling 2.3 (2.16.840.1.113883.2.4.3.11.60.90.77.4.2443 2016-11-23T13:51:47)</title>
   ...
   <!-- Include the project schematrons related to scenario cns-rap-23 -->

   <!-- counseling-23 -->
   <pattern>
      <title>counseling-23</title>
      <rule context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:REPC_IN004014NL[hl7:interactionId[@root = '2.16.840.1.113883.1.6']]"
                 see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.2.4.6.10.90.80-2016-12-16T090911.html">(counseling-23): In de instance werd het volgende element verwacht: descendant-or-self::hl7:REPC_IN004014NL[hl7:interactionId[@root = '2.16.840.1.113883.1.6']]</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.2.4.6.10.90.80-2016-12-16T090911.sch"/>
   <include href="include/2.16.840.1.113883.2.4.6.10.90.80-2016-12-16T090911-closed.sch"/>
