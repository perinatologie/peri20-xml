...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Schematron file for transaction Administratief geboortebericht fase 1a (2.16.840.1.113883.2.4.3.11.60.90.77.4.901 2011-01-28T00:00:00)</title>
   ...
   <!-- admgeboorte-1a -->
   <pattern>
      <title>admgeboorte-1a</title>
      <rule context="/">
         <assert role="warning"
                 test="descendant-or-self::hl7:registrationProcess[hl7:code[(@code = '118118' and @codeSystem = '2.16.840.1.113883.2.4.15.4')]]"
                 see="http://decor.nictiz.nl/perinatologie/peri20-html-20190926T163541/tmp-2.16.840.1.113883.2.4.6.10.90.45-2012-06-26T000000.html">(admgeboorte-1a): In de instance werd het volgende element verwacht: descendant-or-self::hl7:registrationProcess[hl7:code[(@code = '118118' and @codeSystem = '2.16.840.1.113883.2.4.15.4')]]</assert>
      </rule>
   </pattern>
